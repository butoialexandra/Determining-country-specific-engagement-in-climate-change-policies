...
var LDAvis = function(to_select, data_or_file_name, color1, color2) {
    ...
    var K, // number of topics
        ...
        color1 = typeof color1 !=='undefined' ? color1: "#1E1E1E", // baseline color for default topic circles and overall term frequencies
        color2 = typeof color2 !=='undefined' ? color2: "#0b8f4b"; // 'highlight' color for selected topics and term-topic frequencies
